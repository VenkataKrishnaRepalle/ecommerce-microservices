package com.pm.spring.ema.policy.service.exception;
...
public class GlobalClientExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBrandNotFoundException(ClientNotFoundException exception) {
    ...
    @ExceptionHandler(ClientNameAlreadyExistException.class)
    public ResponseEntity<ErrorResponse> handleBrandNameAlreadyExistException(ClientNameAlreadyExistException exception) {
        HttpHeaders headers = new HttpHeaders();
        headers.add(GlobalConstants.TRACE_ID_HEADER, tracer.currentSpan().context().traceIdString());
