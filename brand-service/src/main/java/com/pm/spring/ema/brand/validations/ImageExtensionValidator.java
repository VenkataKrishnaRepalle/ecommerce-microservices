package com.pm.spring.ema.brand.validations;
...
public class ImageExtensionValidator
    implements ConstraintValidator<ValidImageExtension, MultipartFile> {
  @Override
  ...
  public boolean isValid(MultipartFile imageFile, ConstraintValidatorContext context) {
    ...
    try {
      ...
      String extension =
          FileUploadUtils.getExtensionByString(imageFile.getOriginalFilename()).get();
