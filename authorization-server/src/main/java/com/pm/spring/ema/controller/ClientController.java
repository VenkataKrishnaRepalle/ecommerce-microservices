...
public class ClientController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<ClientFindResponseDto> getBrandById(@PathVariable @Valid final UUID id) {
        log.info("BrandController:getBrandById STARTED. request id: {}", id);
        ...
        log.info("BrandController:getBrandById ENDED. response : {}", clientFindResponseDto);
