...
public class MailController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = HttpStatusCodes.OK, description = "Send Login OTP", content = @Content(mediaType = "application/json", schema = @Schema(implementation = HttpStatus.class))),
            @ApiResponse(responseCode = HttpStatusCodes.BAD_REQUEST, description = "Bad Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = HttpStatusCodes.OK, description = "OTP Validation", content = @Content(mediaType = "application/json", schema = @Schema(implementation = HttpStatus.class))),
            @ApiResponse(responseCode = HttpStatusCodes.BAD_REQUEST, description = "Bad Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))),
            @ApiResponse(responseCode = HttpStatusCodes.INTERNAL_SERVER_ERROR, description = "Internal Server Error", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)))
    })
    @PostMapping("/otp-validation/{userId}")
    public ResponseEntity<HttpStatus> otpValidation(@PathVariable @NotNull UUID userId,
    ...
    @Operation(tags = "Mail", summary = "Send Forgot Password OTP", description = "Send Forgot Password OTP to Email")
    @ApiResponses(value = {
            @ApiResponse(responseCode = HttpStatusCodes.OK, description = "Send Forgot Password OTP", content = @Content(mediaType = "application/json", schema = @Schema(implementation = HttpStatus.class))),
            @ApiResponse(responseCode = HttpStatusCodes.BAD_REQUEST, description = "Bad Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))),
            @ApiResponse(responseCode = HttpStatusCodes.INTERNAL_SERVER_ERROR, description = "Internal Server Error", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)))
    })
    @PostMapping("/send-forgot-password-otp/{userId}")
    public ResponseEntity<HttpStatus> sendForgotPasswordOtp(@PathVariable @NotNull UUID userId) throws MessagingException, UnsupportedEncodingException {
