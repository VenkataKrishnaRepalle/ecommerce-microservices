...
public interface MailService {
    ...
    void sendLoginMail(CustomerDetailsDto customerDetailsDto) throws MessagingException, UnsupportedEncodingException;

    void sendForgotPasswordOtp(UUID userId) throws MessagingException, UnsupportedEncodingException;

    void sendForgotPasswordMail(CustomerDetailsDto customerDetailsDto) throws MessagingException, UnsupportedEncodingException;
}
