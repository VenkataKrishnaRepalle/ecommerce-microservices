...
public class BootstrapData implements CommandLineRunner {
  ...
  private void loadBrandData() {
    ...
    if (countryRepository.count() == 0) {
      countryRepository.save(Country.builder().name("India").code("+91").build());

      countryRepository.save(Country.builder().name("America").code("+1").build());

      countryRepository.save(Country.builder().name("China").code("+86").build());
    }
  }
}
