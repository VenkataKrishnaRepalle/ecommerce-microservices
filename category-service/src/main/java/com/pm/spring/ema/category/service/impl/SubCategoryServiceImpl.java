...
public class SubCategoryServiceImpl implements SubCategoryService {
  ...
  public List<SubCategoryDto> getAllSubCategory() {
    ...
    log.debug(
        "SubCategoryService:getAllSubCategory EXECUTION STARTED.  traceId: {}",
        TraceIdHolder.getTraceId());

    List<SubCategoryDto> subCategoryFindResponseDtoList =
        subCategoryRepository.findAll().stream().map(subCategoryMapper::toSubCategoryDto).toList();
    log.debug(
        "SubCategoryService:getAllSubCategory EXECUTION ENDED. traceId: {}, response {} ",
        TraceIdHolder.getTraceId(),
  ...
  public SubCategoryDto getSubCategoryById(UUID id) throws NotFoundException {
    ...
    log.debug(
        "SubCategoryService:getSubCategoryById EXECUTION STARTED.  traceId: {}, id: {}",
        TraceIdHolder.getTraceId(),
        id);
    ...
    if (optionalSubCategory.isEmpty()) {
      log.error(
          "SubCategoryService:getSubCategoryById EXECUTION ENDED. traceId: {} ",
          TraceIdHolder.getTraceId());
      throw new NotFoundException(ErrorCodes.E1509, id.toString());
    }

    SubCategoryDto subCategoryFindResponseDto =
        subCategoryMapper.toSubCategoryDto(optionalSubCategory.get());
    log.debug(
        "SubCategoryService:getSubCategoryById EXECUTION ENDED. traceId: {}, response: {}",
        TraceIdHolder.getTraceId(),
  ...
  @Override
  public SubCategoryDto createSubCategory(SubCategoryDto subCategoryCreateRequestDto)
      throws FoundException {

    log.debug(
        "SubCategoryService:createSubCategory EXECUTION STARTED. traceId: {} , brandCreateRequestDto: {}",
        TraceIdHolder.getTraceId(),
        subCategoryCreateRequestDto);

    if (isSubCategoryExistByName(subCategoryCreateRequestDto.getName())) {
      log.error(
          "SubCategoryService:createSubCategory EXECUTION ENDED. traceId: {}, errorMessage: {}",
          TraceIdHolder.getTraceId(),
          ErrorMessage.message(ErrorCodes.E1508, subCategoryCreateRequestDto.getName()));
    ...
    Category category =
        categoryRepository
            .findById(categoryId)
            .orElseThrow(() -> new NotFoundException(ErrorCodes.E1507, categoryId.toString()));
  ...
  @Override
  public SubCategoryDto updateSubCategory(final UUID id, SubCategoryDto subCategoryRequestDto)
      throws NotFoundException {
    log.debug(
        "SubCategoryService:updateSubCategory EXECUTION STARTED. traceId: {}, id: {}, brandCreateRequestDto: {}",
        TraceIdHolder.getTraceId(),
        id,
    ...
    SubCategoryDto subCategoryUpdateResponseDto =
        subCategoryMapper.toSubCategoryDto(updatedSubCategory);

    log.debug(
        "SubCategoryService:updateSubCategory EXECUTION ENDED.traceId: {}, response: {}",
        TraceIdHolder.getTraceId(),
  ...
  public SubCategoryDto deleteSubCategoryById(UUID id) throws NotFoundException {
    ...
    log.debug(
        "SubCategoryService:deleteSubCategoryById EXECUTION STARTED. traceId: {}, id: {}",
        TraceIdHolder.getTraceId(),
        id);
    ...
    if (optionalSubCategory.isPresent()) {
      ...
      SubCategoryDto categoryDeleteResponseDto =
          subCategoryMapper.toSubCategoryDto(optionalSubCategory.get());
      ...
      log.error(
          "SubCategoryService:deleteSubCategoryById EXECUTION ENDED. traceId: {}, errorMessage: {}",
          TraceIdHolder.getTraceId(),
          ErrorMessage.message(ErrorCodes.E1511, id.toString()));
  ...
  public List<SubCategoryDto> getSubCategoriesByCategoryId(UUID categoryId) {
    ...
    return subCategoryRepository.findByCategory(Category.builder().id(categoryId).build()).stream()
  ...
  public List<SubCategoryDto> findByPage(
    ...
    if (keyword != null) {
      return subCategoryRepository.findAllByPage(keyword, (pageable)).stream()
          .map(subCategoryMapper::toSubCategoryDto)
          .toList();
    }
  ...
  public String updateSubCategoryImageById(UUID id, String fileName) throws NotFoundException {
    ...
    log.debug(
        "SubCategoryService:updateSubCategoryImageById EXECUTION STARTED. traceId: {}, brandId:{}, fileName: {}",
        TraceIdHolder.getTraceId(),
        id,
        fileName);
    ...
    if (optionalSubCategory.isEmpty()) {
      log.error(
          "SubCategoryService:updateSubCategoryImageById EXECUTION ENDED. traceId: {}, errorMessage:{}",
          TraceIdHolder.getTraceId(),
    ...
    log.debug(
        "SubCategoryService:updateSubCategoryImageById EXECUTION ENDED. traceId: {}, updatedImageName: {}",
        TraceIdHolder.getTraceId(),
        updatedSubCategory.getImageName());
