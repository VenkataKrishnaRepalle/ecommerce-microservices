package com.pm.spring.ema.analytics.service.business.impl;

import com.pm.spring.ema.analytics.service.business.KafkaConsumer;
import com.pm.spring.ema.analytics.service.dataaccess.entity.MessageAnalyticsEntity;
import com.pm.spring.ema.analytics.service.dataaccess.repository.AnalyticsRepository;
import com.pm.spring.ema.analytics.service.transformer.KafkaToDbEntityModelTransformer;
...
@Service
public class AnalyticsKafkaConsumer implements KafkaConsumer<MessageAnalyticsKafkaModel> {
    ...
    private final KafkaToDbEntityModelTransformer kafkaToDbEntityModelTransformer;
    ...
    public void receive(@Payload List<MessageAnalyticsKafkaModel> messages,
        ...
        List<MessageAnalyticsEntity> twitterAnalyticsEntities = kafkaToDbEntityModelTransformer.getEntityModel(messages);
