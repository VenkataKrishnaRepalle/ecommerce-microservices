...
import com.pm.spring.ema.analytics.service.transformer.EntityToResponseModelTransformer;
...
public class TwitterAnalyticsService implements AnalyticsService {
    ...
    @Override
    public Optional<MessageAnalyticsResponseModel> getWordAnalytics(String word) {
