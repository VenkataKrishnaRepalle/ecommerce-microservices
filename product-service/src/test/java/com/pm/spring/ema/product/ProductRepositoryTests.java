...
public class ProductRepositoryTests {
  ...
  //        BrandDto brandDto = entityManager.find(BrandDto.class,
  // "a3976462-93b7-4303-b504-0e5b0eddb283");
  //        CategoryDto categoryDto = entityManager.find(CategoryDto.class,
  // "3540536f-5468-42d4-92ff-9a576c3e7747");
