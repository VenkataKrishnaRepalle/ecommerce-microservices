...
public class ProductController {
  ...
  public ResponseEntity<ProductCreateResponseDto> create(
      @RequestBody @Valid final ProductCreateRequestDto productCreateRequestDto) {
  ...
  public ResponseEntity<ProductUpdateResponseDto> update(
      @PathVariable UUID id, @RequestBody ProductUpdateRequestDto productUpdateRequestDto) {
    return new ResponseEntity<>(
        productService.update(id, productUpdateRequestDto), HttpStatus.ACCEPTED);
  }
  ...
  public ResponseEntity<List<ProductFindResponseDto>> getByCategoryId(
  ...
  public ResponseEntity<List<ProductFindResponseDto>> getByCategoryIdAndBrandId(
